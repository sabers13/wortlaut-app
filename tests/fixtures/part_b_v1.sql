-- M4 test fixture: exact pre-M4 PART-B schema at main ef1074214101508a617b0d8dc62334f795674e5b.
--
-- This is the PART-B section of reference/schema.sql AFTER the M2
-- duplicate-identity unit and BEFORE the M4 folder unit: it carries
-- note.dictionary_key and the partial UNIQUE identity index, and
-- PRAGMA user_version = 1. It has no folder table, no deck.folder_id,
-- and no ix_deck_folder index.
--
-- Tests build version-1 databases from THIS file only. Never generate old
-- DBs by taking the current v2 schema and deleting lines at runtime. No
-- PART-A tables here.
-- ============================================================
...
-- M2 PART-B schema version. Fresh databases are created at version 1.
